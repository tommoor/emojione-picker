  ...
  getCategories: function () {
    ...
    _.each(this.props.categories, function (details, key) {
      headers.push(React.createElement(
        ...
        React.createElement(Emoji, { role: "menuitem", "aria-label": key + " category", shortname: ":" + details.emoji + ":", onClick: function () {
            jumpToCategory(key);
          } })
      ));
    }.bind(this));
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        this.getSearchInput(),
        this.getEmojis(),
        this.props.showAttribution && React.createElement(
          "div",
          { className: "emojione-attribution" },
          React.createElement(
            "span",
            null,
          ...
          React.createElement(
            "a",
            { href: "http://emojione.com", target: "_blank" },
            "Emoji One"
          )
        )
      )
