...
var Picker = React.createClass({
  ...
  propTypes: {
    search: React.PropTypes.oneOfType([React.PropTypes.string, React.PropTypes.boolean]),
  ...
  getCategories: function () {
    ...
    _.each(this.props.categories, function (details, key) {
      headers.push(React.createElement(
        ...
        React.createElement(Emoji, { role: "menuitem", "aria-label": key + " category", shortname: ":" + details.emoji + ":", useNative: this.props.useNative, onClick: function () {
            jumpToCategory(key);
          } })
      ));
    }.bind(this));
        ...
        list = _.map(list, function (data) {
          ...
          if (!search || !term || modified.keywords.some(function (keyword) {
            ...
            return React.createElement(
              ...
              React.createElement(Emoji, _extends({}, modified, { "aria-label": modified.name, role: "option", useNative: this.props.useNative, onClick: function () {
                  onChange(modified);
                } }))
            );
          }
