...
var Picker = React.createClass({
  ...
  propTypes: {
    search: React.PropTypes.oneOfType([React.PropTypes.bool, React.PropTypes.string]),
  ...
  getCategories: function getCategories() {
    ...
    _.each(this.props.categories, function (details, key) {
      headers.push(React.createElement(
        ...
        React.createElement(Emoji, { id: key, role: "menuitem", "aria-label": key + " category", shortname: ":" + details.emoji + ":", onClick: function onClick() {
            jumpToCategory(key);
        ...
        list = _.map(list, function (data) {
          ...
          if (!search || !term || modified.keywords.some(function (keyword) {
            ...
            return React.createElement(
              ...
              React.createElement(Emoji, _extends({}, modified, { ariaLabel: modified.name, role: "option", onClick: function onClick() {
                  onChange(modified);
                }, onKeyUp: function onKeyUp(e) {
                  e.preventDefault();
